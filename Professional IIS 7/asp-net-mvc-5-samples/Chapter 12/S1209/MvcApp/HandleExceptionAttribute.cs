...
public class HandleExceptionAttribute: FilterAttribute, IExceptionFilter
{
    ...
    public HandleErrorActionInvoker ErrorActionInvoker { get; private set; }
    public HandleExceptionAttribute(string excptionPolicy)
    {
        this.ExceptionPolicy = excptionPolicy;
        this.ErrorActionInvoker = new HandleErrorActionInvoker();
    }
    ...
    public void OnException(ExceptionContext filterContext)
    {
        ...
        else
        {
            ...
            filterContext.Result = this.ErrorActionInvoker.InvokeActionMethod(filterContext, handleErrorActionDescriptor);
        }
    }
